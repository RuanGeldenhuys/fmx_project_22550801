...
table <- xtable(results_SP$HighVol, caption = "S\\&P 500 High Volatility")
print.xtable(table,
             # tabular.environment = "longtable",
             floating = TRUE,
             table.placement = 'H',
...
table <- xtable(results_SP$LowVol, caption = "S\\&P 500 Low Volatility")
print.xtable(table,
             # tabular.environment = "longtable",
             floating = TRUE,
             table.placement = 'H',
...
```{r, results='asis'}
results_JSE <- analyze_volatility_periods(joinedDF, "JSE40", Idxs)
table <- xtable(results_JSE$HighVol, caption = "JSE Top 40 High Volatility")
print.xtable(table,
             # tabular.environment = "longtable",
             floating = TRUE,
             table.placement = 'H',
...
table <- xtable(results_JSE$LowVol, caption = "JSE Top 40 Low Volatility")
print.xtable(table,
             # tabular.environment = "longtable",
             floating = TRUE,
             table.placement = 'H',
...
```{r, results='asis'}
results_rand <- analyze_volatility_periods(joinedDF, "ZARUSD", Idxs)
table <- xtable(results_rand$HighVol, caption = "ZAR/USD High Volatility")
print.xtable(table,
             # tabular.environment = "longtable",
             floating = TRUE,
             table.placement = 'H',
...
table <- xtable(results_rand$LowVol, caption = "ZAR/USD Low Volatility")
print.xtable(table,
             # tabular.environment = "longtable",
             floating = TRUE,
             table.placement = 'H',
