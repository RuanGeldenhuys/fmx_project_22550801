...
dcc_JSE <- ggplot(Rhot %>% filter(grepl("JSE_", Pairs ), !grepl("_JSE", Pairs)) ) + 
    ...
    annotate("rect", xmin = as.Date("2020-03-15"), xmax = as.Date("2021-12-01"),
