...
```{r, results='asis'}
table <- xtable(renamed_BEKK_estimates$Constants, caption = "BEKK-GARCH Constants \\label{tab10}", digits = c(0,4,4,4))
print.xtable(table,
             # tabular.environment = "longtable",
             floating = TRUE,
             table.placement = 'H',
...
```
```{r, results='asis'}
table <- xtable(renamed_BEKK_estimates$`ARCH estimates`, caption = "BEKK-GARCH ARCH estimates \\label{tab11}", digits = c(0,4,4,4))
print.xtable(table,
             # tabular.environment = "longtable",
             floating = TRUE,
             table.placement = 'H',
...
```
```{r, results='asis'}
table <- xtable(renamed_BEKK_estimates$`GARCH estimates`, caption = "BEKK-GARCH GARCH estimates \\label{tab12}", digits = c(0,4,4,4))
print.xtable(table,
             # tabular.environment = "longtable",
             floating = TRUE,
             table.placement = 'H',
